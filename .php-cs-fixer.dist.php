 ...
 *
 * examples/ and benchmarks/ are included: they are read as much as src/ is,
 * and a snippet that formats differently from the code it demonstrates is a
 * snippet that teaches the wrong habit.
 */
